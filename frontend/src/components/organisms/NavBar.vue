...
<template>
    ...
    >
        ...
        ></MenuItem>
        <MenuItem customClass="menu-item">A805 마니또</MenuItem>
        <MenuItem
            customClass="menu-item"
            :active="activeMenu === 1"
        ...
        <div v-if="showSubMenu.includes('chat')">
            <MenuItem customClass="sub-menu-item">마니또와의 채팅</MenuItem>
            <MenuItem customClass="sub-menu-item">마니띠와의 채팅</MenuItem>
            <MenuItem customClass="sub-menu-item">단체 채팅</MenuItem>
        </div>
        <!-- 다른 세부 메뉴들도 추가 가능 -->
        <MenuItem
            customClass="menu-item"
        ...
        <div v-if="showSubMenu.includes('board')">
            <MenuItem customClass="sub-menu-item">공지 게시판</MenuItem>
            <MenuItem customClass="sub-menu-item">인증 게시판</MenuItem>
            <MenuItem customClass="sub-menu-item">자랑 게시판</MenuItem>
        </div>
        <MenuItem
            customClass="menu-item"
            :active="activeMenu === 7"
